        ...
        drag: function(e, i) {
            for (var s = t(this).data("draggable"), n = s.options, a = n.snapTolerance, o = i.offset.left, r = o + s.helperProportions.width, h = i.offset.top, l = h + s.helperProportions.height, c = s.snapElements.length - 1; c >= 0; c--) {
                ...
                if (u - a < o && o < d + a && p - a < h && h < f + a || u - a < o && o < d + a && p - a < l && l < f + a || u - a < r && r < d + a && p - a < h && h < f + a || u - a < r && r < d + a && p - a < l && l < f + a) {
                    ...
                    var b = g || m || v || _;
                    if ("outer" != n.snapMode) {
                        g = Math.abs(p - h) <= a, m = Math.abs(f - l) <= a, v = Math.abs(u - o) <= a, _ = Math.abs(d - r) <= a;
                        g && (i.position.top = s._convertPositionTo("relative", {
                            top: p,
                            left: 0
                        }).top - s.margins.top), m && (i.position.top = s._convertPositionTo("relative", {
                ...
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    ...
                    if (n) {
                        ...
                        if (this.options.greedy) {
                            ...
                            r.length && ((a = t.data(r[0], "droppable")).greedyChild = "isover" == n ? 1 : 0)
                        }
...
function(t, e) {
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _getItemsAsjQuery: function(e) {
            ...
            for (a = s.length - 1; a >= 0; a--) s[a][0].each(function() {
                i.push(this)
            });
            return t(i)
        },
        ...
        _refreshItems: function(e) {
            ...
            for (a = s.length - 1; a >= 0; a--)
                for (var l = s[a][1], c = s[a][0], u = (r = 0, c.length); r < u; r++) {
                    var d = t(c[r]);
                ...
                u.style.cssText = "background-color:rgba(1,1,1,.5)", c.rgba = u.style.backgroundColor.indexOf("rgba") > -1, d(h, function(t, e) {
                    ...
                    parse: function(n, a, o, l) {
                        ...
                        return a !== i && (n = [n, a, o, l], u = "array"), "string" === u ? this.parse(f(n) || s._default) : "array" === u ? (d(h.rgba.props, function(t, e) {
                            g[e.idx] = p(n[e.idx], e)
                        }), this) : "object" === u ? (d(h, n instanceof r ? function(t, e) {
                    ...
                    var e, i, s = t[0] / 255,
                        ...
                        c = r + h,
                        u = .5 * c;
                    return e = h === r ? 0 : s === r ? 60 * (n - a) / l + 360 : n === r ? 60 * (a - s) / l + 120 : 60 * (s - n) / l + 240, i = 0 === u || 1 === u ? u : u <= .5 ? l / c : l / (2 - c), [Math.round(e) % 360, i, u, null == o ? 1 : o]
                ...
                t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(e, i) {
                    ...
                    return this.queue(function() {
                        ...
                        l = l.map(function() {
                            ...
                            return this.end = s.call(this.el[0]), this.diff = function(e, s) {
                                var n, a, o = {};
                                for (n in s) a = s[n], e[n] !== a && (i[n] || !t.fx.step[n] && isNaN(parseFloat(a)) || (o[n] = a));
                                return o
                    ...
                    toggleClass: function(e, i, s, n, a) {
                        return "boolean" == typeof i || void 0 === i ? s ? t.effects.animateClass.call(this, i ? {
                            add: e
                        } : {
                            remove: e
                        }, s, n, a) : this._toggleClass(e, i) : t.effects.animateClass.call(this, {
                            toggle: e
                        }, i, s, n)
                    },
            ...
            function() {
                ...
                t.extend(t.effects, {
                    ...
                    restore: function(t, e) {
                        var i, s;
                        for (s = 0; s < e.length; s++) null !== e[s] && (void 0 === (i = t.data(n + e[s])) && (i = ""), t.css(e[s], i))
                    },
                    ...
                    effect: function() {
                        var i = e.apply(this, arguments),
                            ...
                            r = !o && s && t.effects[i.effect];
                        if (t.fx.off || !o && !r) return n ? this[n](i.duration, i.complete) : this.each(function() {
                        ...
                        function h(e) {
                            ...
                            }(s.is(":hidden") ? "hide" === a : "show" === a) ? r(): o.call(s[0], i, r)
                        }
                    ...
                    toggle: function(s) {
                        if (i(s) || "boolean" == typeof s || t.isFunction(s)) return this.__toggle.apply(this, arguments);
    ...
    function(t, e) {
        ...
        s.height = s.paddingTop = s.paddingBottom = s.borderTopWidth = s.borderBottomWidth = "hide", n.height = n.paddingTop = n.paddingBottom = n.borderTopWidth = n.borderBottomWidth = "show", t.widget("ui.accordion", {
            ...
            _eventHandler: function(e) {
                ...
                e.preventDefault(), a && !i.collapsible || !1 === this._trigger("beforeActivate", e, h) || (i.active = !o && this.headers.index(n), this.active = a ? t() : n, this._toggle(h), s.removeClass("ui-accordion-header-active ui-state-active"), i.icons && s.children(".ui-accordion-header-icon").removeClass(i.icons.activeHeader).addClass(i.icons.header), a || (n.removeClass("ui-corner-all").addClass("ui-accordion-header-active ui-state-active ui-corner-top"), i.icons && n.children(".ui-accordion-header-icon").removeClass(i.icons.header).addClass(i.icons.activeHeader), n.next().addClass("ui-accordion-content-active")))
            },
            _toggle: function(e) {
                var i = e.newPanel,
            ...
            _animate: function(t, e, i) {
                ...
                return "number" == typeof d && (r = d), "string" == typeof d && (o = d), o = o || d.easing || u.easing, r = r || d.duration || u.duration, e.length ? t.length ? (a = t.show().outerHeight(), e.animate(s, {
                    duration: r,
                    easing: o,
                    step: function(t, e) {
                        e.now = Math.round(t)
                ...
                })) : e.animate(s, r, o, p) : t.animate(n, r, o, p)
            },
    ...
    function($, undefined) {
        ...
        $.extend(Datepicker.prototype, {
            ...
            parseDate: function(t, e, i) {
                ...
                for (var n = (i ? i.dayNamesShort : null) || this._defaults.dayNamesShort, a = (i ? i.dayNames : null) || this._defaults.dayNames, o = (i ? i.monthNamesShort : null) || this._defaults.monthNamesShort, r = (i ? i.monthNames : null) || this._defaults.monthNames, h = -1, l = -1, c = -1, u = -1, d = !1, p = function(e) {
                    ...
                    if (d) "'" != t.charAt(_) || p("'") ? m() : d = !1;
                        ...
                        case "y":
                            ...
                            break;
                        case "@":
                            h = (b = new Date(f("@"))).getFullYear(), l = b.getMonth() + 1, c = b.getDate();
                            break;
                        case "!":
                            var b;
                            h = (b = new Date((f("!") - this._ticksTo1970) / 1e4)).getFullYear(), l = b.getMonth() + 1, c = b.getDate();
                            break;
                        case "'":
                            p("'") ? m() : d = !0;
                            break;
                ...
                if ((b = this._daylightSavingAdjust(new Date(h, l - 1, c))).getFullYear() != h || b.getMonth() + 1 != l || b.getDate() != c) throw "Invalid date";
                return b
            },
            ATOM: "yy-mm-dd",
            COOKIE: "D, dd M yy",
            ...
            _determineDate: function(t, e, i) {
                var s, n, a = null == e || "" === e ? i : "string" == typeof e ? function(e) {
                    try {
                        return $.datepicker.parseDate($.datepicker._get(t, "dateFormat"), e, $.datepicker._getFormatConfig(t))
                    } catch (t) {}
                    for (var i = (e.toLowerCase().match(/^c/) ? $.datepicker._getDate(t) : null) || new Date, s = i.getFullYear(), n = i.getMonth(), a = i.getDate(), o = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, r = o.exec(e); r;) {
                        switch (r[2] || "d") {
                            case "d":
                            case "D":
                                a += parseInt(r[1], 10);
            ...
            _generateHTML: function(t) {
                ...
                for (var D = this._get(t, "showWeek"), P = this._get(t, "dayNames"), I = (this._get(t, "dayNamesShort"), this._get(t, "dayNamesMin")), M = this._get(t, "monthNames"), T = this._get(t, "monthNamesShort"), S = this._get(t, "beforeShowDay"), A = this._get(t, "showOtherMonths"), z = this._get(t, "selectOtherMonths"), H = (this._get(t, "calculateWeek") || this.iso8601Week, this._getDefaultDate(t)), N = "", E = 0; E < o[0]; E++) {
                    ...
                    for (var O = 0; O < o[1]; O++) {
                        ...
                        for (var L = D ? '<th class="ui-datepicker-week-col">' + this._get(t, "weekHeader") + "</th>" : "", Y = 0; Y < 7; Y++) {
                            var B = (Y + C) % 7;
    ...
    function(t, e) {
        ...
        t.widget("ui.dialog", {
            ...
            height: function() {
                var e;
                return t.ui.ie ? (e = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight)) < Math.max(document.documentElement.offsetHeight, document.body.offsetHeight) ? t(window).height() + "px" : e + "px" : t(document).height() + "px"
            },
            width: function() {
                var e;
                return t.ui.ie ? (e = Math.max(document.documentElement.scrollWidth, document.body.scrollWidth)) < Math.max(document.documentElement.offsetWidth, document.body.offsetWidth) ? t(window).width() + "px" : e + "px" : t(document).width() + "px"
            },
            resize: function() {
                var e = t([]);
    ...
    function(t, e) {
        t.effects.effect.bounce = function(e, i) {
            ...
            for ((c || l) && r.push("opacity"), t.effects.save(o, r), o.show(), t.effects.createWrapper(o), d || (d = o["top" === v ? "outerHeight" : "outerWidth"]() / 3), c && ((a = {
                    opacity: 1
                })[v] = 0, o.css("opacity", 0).css(v, _ ? 2 * -d : 2 * d).animate(a, g, m)), l && (d /= Math.pow(2, p - 1)), (a = {})[v] = 0, s = 0; s < p; s++)(n = {})[v] = (_ ? "-=" : "+=") + d, o.animate(n, g, m).animate(a, g, m), d = l ? 2 * d : d / 2;
            l && ((n = {
                opacity: 0
            })[v] = (_ ? "-=" : "+=") + d, o.animate(n, g, m)), o.queue(function() {
    ...
    function(t, e) {
        t.effects.effect.explode = function(e, i) {
            ...
            for (s = 0; s < l; s++)
                for (o = p.top + s * g, h = s - (l - 1) / 2, n = 0; n < c; n++) a = p.left + n * f, r = n - (c - 1) / 2, u.clone().appendTo("body").wrap("<div></div>").css({
                    position: "absolute",
                    visibility: "visible",
                    left: -n * f,
                    top: -s * g
    ...
    function(t, e) {
        t.effects.effect.puff = function(e, i) {
            ...
            var s, n, a, o = t(this),
                ...
                d = t.effects.setMode(o, e.mode || "effect"),
            ...
            "show" === d && o.show(), s = {
            ...
            }, "toggle" === e.mode && "show" === d ? (o.from = e.to || _, o.to = e.from || s) : (o.from = e.from || ("show" === d ? _ : s), o.to = e.to || ("hide" === d ? _ : s)), a = {
                from: {
            ...
            }, "box" !== f && "both" !== f || (a.from.y !== a.to.y && (v = v.concat(c), o.from = t.effects.setTransition(o, c, a.from.y, o.from), o.to = t.effects.setTransition(o, c, a.to.y, o.to)), a.from.x !== a.to.x && (v = v.concat(u), o.from = t.effects.setTransition(o, u, a.from.x, o.from), o.to = t.effects.setTransition(o, u, a.to.x, o.to))), "content" !== f && "both" !== f || a.from.y !== a.to.y && (v = v.concat(l).concat(h), o.from = t.effects.setTransition(o, l, a.from.y, o.from), o.to = t.effects.setTransition(o, l, a.to.y, o.to)), t.effects.save(o, v), o.show(), t.effects.createWrapper(o), o.css("overflow", "hidden").css(o.from), g && (n = t.effects.getBaseline(g, s), o.from.top = (s.outerHeight - o.outerHeight()) * n.y, o.from.left = (s.outerWidth - o.outerWidth()) * n.x, o.to.top = (s.outerHeight - o.to.outerHeight) * n.y, o.to.left = (s.outerWidth - o.to.outerWidth) * n.x), o.css(o.from), "content" !== f && "both" !== f || (c = c.concat(["marginTop", "marginBottom"]).concat(l), u = u.concat(["marginLeft", "marginRight"]), h = r.concat(c).concat(u), o.find("*[width]").each(function() {
                var i = t(this),
                    s = i.height(),
                    n = i.width(),
                    o = i.outerHeight(),
                ...
                p && t.effects.save(i, h), i.from = {
                    ...
                    outerWidth: n * a.to.x
                }, a.from.y !== a.to.y && (i.from = t.effects.setTransition(i, c, a.from.y, i.from), i.to = t.effects.setTransition(i, c, a.to.y, i.to)), a.from.x !== a.to.x && (i.from = t.effects.setTransition(i, u, a.from.x, i.from), i.to = t.effects.setTransition(i, u, a.to.x, i.to)), i.css(i.from), i.animate(i.to, e.duration, e.easing, function() {
                ...
                easing: e.easing,
                complete: function() {
                    0 === o.to.opacity && o.css("opacity", o.from.opacity), "hide" === d && o.hide(), t.effects.restore(o, v), p || ("static" === m ? o.css({
                        position: "relative",
                        top: o.to.top,
                        left: o.to.left
            ...
            _keydown: function(e) {
                ...
                switch (e.keyCode) {
                    ...
                    case t.ui.keyCode.ESCAPE:
                        ...
                        break;
                    default:
                        r = !1, s = this.previousFilter || "", n = String.fromCharCode(e.keyCode), a = !1, clearTimeout(this.filterTimer), n === s ? a = !0 : n = s + n, o = new RegExp("^" + h(n), "i"), i = this.activeMenu.children(".ui-menu-item").filter(function() {
                            return o.test(t(this).children("a").text())
                        }), (i = a && -1 !== i.index(this.active.next()) ? this.active.nextAll(".ui-menu-item") : i).length || (n = String.fromCharCode(e.keyCode), o = new RegExp("^" + h(n), "i"), i = this.activeMenu.children(".ui-menu-item").filter(function() {
                            return o.test(t(this).children("a").text())
        ...
        t.position = {
                scrollbarWidth: function() {
                    ...
                    var e, s, n = t("<div style='display:block;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),
                        a = n.children()[0];
                    return t("body").append(n), e = a.offsetWidth, n.css("overflow", "scroll"), e === (s = a.offsetWidth) && (s = n[0].clientWidth), n.remove(), i = e - s
                },
                ...
                return 9 === y.nodeType ? (s = v.width(), n = v.height(), d = {
                ...
                }), 1 === w.length && (w[1] = w[0]), "right" === e.at[0] ? m.left += s : "center" === e.at[0] && (m.left += s / 2), "bottom" === e.at[1] ? m.top += n : "center" === e.at[1] && (m.top += n / 2), i = f(x.at, s, n), m.left += i[0], m.top += i[1], this.each(function() {
                    var h, l, c = t(this),
                        u = c.outerWidth(),
                        p = c.outerHeight(),
                        y = g(this, "marginLeft"),
                        k = g(this, "marginTop"),
                        C = u + y + g(this, "marginRight") + b.width,
                        D = p + k + g(this, "marginBottom") + b.height,
                        P = t.extend({}, m),
                        I = f(x.my, c.outerWidth(), c.outerHeight());
                    "right" === e.my[0] ? P.left -= u : "center" === e.my[0] && (P.left -= u / 2), "bottom" === e.my[1] ? P.top -= p : "center" === e.my[1] && (P.top -= p / 2), P.left += I[0], P.top += I[1], t.support.offsetFractions || (P.left = r(P.left), P.top = r(P.top)), h = {
                        ...
                        t.ui.position[w[a]] && t.ui.position[w[a]][o](P, {
                            targetWidth: s,
                            targetHeight: n,
                            elemWidth: u,
                            elemHeight: p,
            ...
            }(), !1 !== t.uiBackCompat && (s = jQuery, n = s.fn.position, s.fn.position = function(t) {
                if (!t || !t.offset) return n.call(this, t);
                var e = t.offset.split(" "),
                    i = t.at.split(" ");
                return 1 === e.length && (e[1] = e[0]), /^\d/.test(e[0]) && (e[0] = "+" + e[0]), /^\d/.test(e[1]) && (e[1] = "+" + e[1]), 1 === i.length && (/left|center|right/.test(i[0]) ? i[1] = "center" : (i[1] = i[0], i[0] = "center")), n.call(this, s.extend(t, {
                    at: i[0] + e[0] + " " + i[1] + e[1],
                    offset: void 0
                }))
            })
    ...
    function(t, e) {
        t.widget("ui.slider", t.ui.mouse, {
            ...
            _create: function() {
                ...
                this.handles = n.add(t(a.join("")).appendTo(this.element)), this.handle = this.handles.eq(0), this.handles.add(this.range).filter("a").click(function(t) {
                    t.preventDefault()
                }).mouseenter(function() {
            ...
            _mouseCapture: function(e) {
                ...
                }), !0 === c.range && this.values(1) === c.min && (o += 1, a = t(this.handles[o])), !1 !== this._start(e, o) && (this._mouseSliding = !0, this._handleIndex = o, a.addClass("ui-state-active").focus(), r = a.offset(), h = !t(e.target).parents().andSelf().is(".ui-slider-handle"), this._clickOffset = h ? {
                    left: 0,
                    top: 0
                } : {
    ...
    function(t, e) {
        ...
        t.widget("ui.tabs", {
            ...
            _create: function() {
                ...
                this._on({
                    tabsbeforeload: function(i, s) {
                        t.data(s.tab[0], "cache.tabs") ? i.preventDefault() : s.jqXHR.success(function() {
            ...
            _tabId: function(e) {
                ...
                return i = i[0], t(i).closest("li").attr("aria-controls") || i.title && i.title.replace(/\s/g, "_").replace(/[^\w\u00c0-\uFFFF\-]/g, "") || this.options.idPrefix + a()
            }
        }), t.widget("ui.tabs", t.ui.tabs, {
            options: {
    ...
    function(t) {
        ...
        t.widget("ui.tooltip", {
            ...
            _open: function(e, i, s) {
                var n, a, o, r, h, l, c = t.extend({}, this.options.position);
                s && ((n = this._find(i)).length ? n.find(".ui-tooltip-content").html(s) : (i.is("[title]") && (e && "mouseover" === e.type ? i.attr("title", "") : i.removeAttr("title")), n = this._tooltip(i), r = i, h = n.attr("id"), (l = (r.attr("aria-describedby") || "").split(/\s+/)).push(h), r.data("ui-tooltip-id", h).attr("aria-describedby", t.trim(l.join(" "))), n.find(".ui-tooltip-content").html(s), this.options.track && e && /^mouse/.test(e.type) ? (this._on(this.document, {
                    ...
                    of: i
                }, this.options.position)), n.hide(), this._show(n, this.options.show), this.options.show && this.options.show.delay && (o = setInterval(function() {
                    n.is(":visible") && (u(c.of), clearInterval(o))
